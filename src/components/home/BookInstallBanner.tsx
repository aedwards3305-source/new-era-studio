...
export function BookInstallBanner() {
  return (
    <section className="relative bg-brand-black text-white overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(201,169,110,0.1),_transparent_70%)]" />
      <div className="relative section-padding py-20 lg:py-28">
        <div className="section-width text-center">
          ...
          <h2 className="font-display text-4xl sm:text-5xl lg:text-6xl font-light mb-6">
            Buy Hair. <span className="italic text-brand-gold">Book Install.</span>
          </h2>
